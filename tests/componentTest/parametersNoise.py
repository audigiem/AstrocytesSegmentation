...
class FeaturesTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.base_data = load_data(
            "/home/maudigie/data/outputData/testCPU/dynamic_image_dF.tif"
        )
        self.index_xmin = np.load(
            "/home/maudigie/data/outputData/testCPU/index_Xmin.npy"
        )
        self.index_xmax = np.load(
            "/home/maudigie/data/outputData/testCPU/index_Xmax.npy"
        )
        ...
        self.residualGPU = load_data(
            "/home/maudigie/data/outputData/debug/residualsGPU.tif"
        )
        self.residualCPU = load_data(
            "/home/maudigie/data/outputData/debug/residualsCPU.tif"
        )
    ...
    def test_event_detection(self):
        ...
        """
        std_noise_CPU = estimate_std_over_time_CPU(
            self.base_data, self.index_xmin, self.index_xmax
        )
    ...
    def test_compare_data(self):
        ...
        self.assertTrue(
            compare_files(self.stdMapCPU, self.stdMapGPU, percentage_accuracy=1e-5),
            msg="Standard deviation maps do not match within the threshold.",
        )

        # Compare the residuals
        self.assertTrue(
            compare_files(self.residualCPU, self.residualGPU, percentage_accuracy=1e-5),
