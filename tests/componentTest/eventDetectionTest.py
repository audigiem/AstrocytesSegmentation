...
class EventDetectionTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        """
        self.dataPython = load_data(
            "/home/maudigie/data/outputData/testCPU/activeVoxels.tif"
        )
        self.targetResults = load_data(
            "/home/maudigie/data/outputData/testCPU/ID_calciumEvents.tif"
        )
        ...
        self.params_values = {
            ...
            "paths": {"output_dir": "/home/maudigie/data/outputData/testGPU/"},
            "save": {"save_events": 1},
        }
    ...
    def test_event_detection_GPU(self):
        ...
        id_connections, nb_events = detect_calcium_events_gpu(
            self.dataPython, params_values=self.params_values
        )
