...
class EventDetectionTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.dataPython = load_data(
            "/home/matteo/Bureau/INRIA/codePython/outputdir/checkDirLatestTest/activeVoxels.tif"
        )
        self.targetResults = load_data(
            "/home/matteo/Bureau/INRIA/codeJava/outputdirLatestTest/ID_calciumEvents.tif"
        )
    ...
    def test_event_detection(self):
        ...
        id_connections, nb_events = detect_calcium_events_opti(
